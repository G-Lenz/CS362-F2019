...
int main()
{
    ...
    //Test wtih card chosen that cost more than 3 card trashed
     ...
     assert(mineEffect(copper, gold, state, 0, 0), - 1);
    ...
    int cardAdded = 0;
    mineEffect(silver, gold, state, 0 , 0);
