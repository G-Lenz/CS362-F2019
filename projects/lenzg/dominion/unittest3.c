...
int main()
{
    ...
    assert(ambassadorEffect(choice1, 3, state, 4, 0), -1);
    
    //Test ic hoice2 is too low
    printf("Testing if choice2 too low...\n");
    assert(ambassadorEffect(choice1, -1, state, 4, 0), -1);
